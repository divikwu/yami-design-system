...
先检查最接近的页面和组件，说明哪些可以直接复用、哪些需要页面实现、
哪些需要新能力，再开始创建。
...
页面完成后进入[检查页面](/zh/docs/review-checklist)。任务类型或提示词尚未确定时，先回到[开始创建](/zh/docs/prepare-environment)。组件存在真实缺口时，先[反馈组件能力缺口](/zh/docs/component-gaps)。
