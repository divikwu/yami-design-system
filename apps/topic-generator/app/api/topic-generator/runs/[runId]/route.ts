...
import { refreshStaleTopicGeneratorDeliverables } from "@/lib/topic-generator-preview-refresh";
...
export async function GET(
  ...
  try {
    ...
    await refreshStaleTopicGeneratorDeliverables({ store, renderer, runId });
