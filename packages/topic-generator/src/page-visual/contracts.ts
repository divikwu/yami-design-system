...
export interface TopicPageVisualDirection {
  ...
  attachedReferenceProductIds?: string[];
...
interface TopicPageVisualSceneBriefBase {
...
export type TopicPageVisualSceneBrief = TopicPageVisualSceneBriefBase & (
  | {
