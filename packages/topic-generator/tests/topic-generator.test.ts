...
describe("Topic page planner", () => {
  ...
  it("uses the canonical catalog category as the core shopping role", () => {
    const matcha = {
      ...product("catalog-core", "Uji Matcha Powder", 1, "Tea Brand"),
      categoryL1Id: 3,
      categoryL2Id: 31,
      categoryL3Id: 1691,
      categoryL1Name: "Tea & Beverages",
      categoryL2Name: "Tea",
      categoryL3Name: "Matcha",
    };
    const cookies = {
      ...product("catalog-pairing", "Matcha Cookies", 2, "Snack Brand"),
      categoryL1Id: 1,
      categoryL2Id: 16,
      categoryL3Id: 101,
      categoryL1Name: "Snack",
      categoryL2Name: "Cookies & Cakes",
      categoryL3Name: "Cookies",
    };
    const plan = buildTopicPagePlan(
      {
        ...snapshot([matcha, cookies]),
        keyword: "matcha",
    ...
    expect(plan.selectedCategories).toEqual(expect.arrayContaining([
      expect.objectContaining({ label: "Matcha", role: "core", source: "catalog-category" }),
      expect.objectContaining({ label: "Cookies", role: "pairing", source: "catalog-category" }),
    ]));
  });
